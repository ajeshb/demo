  ...
  render() {
    return (
      <div className="row todo-details" onDoubleClick={this.enableEditing}>
        ...
        <input
          className="col-sm-8 todo-name"
          type="text"
          value={this.state.value}
          onBlur={this.editTodoTitle}
          onKeyUp={this.editValue}
          onChange={this.makeValueChange}
          readOnly={!this.state.showEdit}
        />
